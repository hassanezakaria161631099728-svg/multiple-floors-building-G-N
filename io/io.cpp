...
#include <iomanip>
#include "../helper_functions/fem.h"
#include <iostream>
BuildingData readInput(const char* filename)
{
    ...
    {
        if(word == "q") file >> d.q;
        else if(word == "nspan") file >> d.nspan;
        else if(word == "Lspan") file >> d.Lspan;
        else if(word == "nstories") file >> d.nstories;
        else if(word == "hstory") file >> d.h;
        else if(word == "E") file >> d.E;
        else if(word == "Acol") file >> d.Acol;
        else if(word == "Icol") file >> d.Icol;
        else if(word == "Abeam") file >> d.Abeam;
        else if(word == "Ibeam") file >> d.Ibeam;
    }
